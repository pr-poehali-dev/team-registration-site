...
-- 5. Пользователи Telegram (для уведомлений)
...
-- Настройки регистрации (открыта по умолчанию)
...
-- 1. Загрузите PHP файлы на сервер
-- 2. Откройте сайт и войдите как @Rywrxuna
-- 3. Начните принимать регистрации команд
-- ====================================